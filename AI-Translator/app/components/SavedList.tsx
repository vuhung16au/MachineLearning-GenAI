          ...
          <li key={index} className="p-4 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
            <div className="flex flex-col gap-1">
              ...
              <div className="flex mt-2 space-x-2">
                ...
                <Button 
                  variant="outline" 
                  className="text-xs py-1 text-red-600 border-red-600 hover:bg-red-50 dark:text-red-400 dark:border-red-400 dark:hover:bg-gray-800"
                  onClick={() => {
                    onRemove(index);
                  }}
                >
